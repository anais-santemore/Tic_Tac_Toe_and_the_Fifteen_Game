        ...
        <Container className={classes.root} maxWidth='md' >
            ...
            <Grid container>
                ...
                <Typography paragraph align='justify' color='textPrimary' component='p' variant='body1' gutterBottom >
                    Proof is the foundation that all Mathematics sits upon, but the practice of writing "proofs" is it is often
                    Mathematics is not just a static set of rules to memorize, it is a subject that is still growing with new discoveries.
                    It is a human endeavor, an expression of creativity. 
                    Mathematical proofs can be beautiful and elegant, however, to the untrained eye, this can be difficult to pick up on
                    because proofs often involve a lot of abstraction and formal definitions. 
                </Typography>
                <Typography paragraph align='justify' color='textPrimary' component='p' variant='body1' gutterBottom >
                    The current usual way students are introduced to the practice of writing "proofs" is
                    in the context of a geometry class, while simultaneously being introduced to similar and congruent
